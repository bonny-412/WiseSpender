...
public class CategoryIncomeFragment extends Fragment implements RecyclerViewClickInterface {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        root = inflater.inflate(R.layout.fragment_category_income, container, false);
        init();
        ...
        listViewCategory.setLayoutManager(new LinearLayoutManager(root.getContext()));
        ...
        buttonNewCategory.setOnClickListener(view -> {
            ...
            CategoryBean categoryBeanNew = new CategoryBean(TypeObjectBean.CATEGORY_INCOME);
