...
public class CurrencyEditText extends AppCompatEditText {
    ...
    private final CurrencyTextWatcher currencyTextWatcher = new CurrencyTextWatcher(this, prefix);
    ...
    private static class CurrencyTextWatcher implements TextWatcher {
        ...
        private void handleSelection() {
            editText.setSelection(Math.min(editText.getText().length(), MAX_LENGTH));
        }
    }
}